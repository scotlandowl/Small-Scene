...
class DukeMTMCreID(BaseImageDataset):
    ...
    # cameras: 8
    """
    # dataset_dir = 'Small_Scenes'
    dataset_dir = 'Small_Scenes_1'

    def __init__(self, root='', query_path='query', verbose=True, pid_begin=0, **kwargs):
        ...
        self.train_dir = osp.join(root, 'Small_Scenes', 'bounding_box_train')
        self.query_dir = osp.join(self.dataset_dir, query_path)
        ...
        # if verbose:
        if verbose and query_path == 'query':
